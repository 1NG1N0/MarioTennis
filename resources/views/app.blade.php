        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    @auth
                    <li class="nav-item"><a class="nav-link" href="{{ route('torneio.inscricao') }}">Inscrever-se</a></li>
                    @endauth
                    <li class="nav-item"><a class="nav-link" href="#">Equipes</a></li>
                    <li class="nav-item"><a class="nav-link" href="{{ route('site.personagens') }}">Personagens</a></li>
...
<footer class="bg-dark text-white text-center py-3 mt-auto">
    <p>&copy; 2025 EGAP - Encontro Geek do Agreste Potiguar. Todos os direitos devem ser respeitados.</p>
</footer>
</html>
